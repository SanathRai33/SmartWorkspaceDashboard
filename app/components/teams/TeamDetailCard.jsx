...
function TeamDetailCard({ id, date, endDate, name, description }) {
    ...
    return (
        <div className='bg-white rounded-xl w-full lg:w-250 shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow'>
