                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="px-1 py-2 bg-white border border-gray-300 rounded-lg max-w-40 lg:w-fit focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
                            <option className="text-2xl max-w-40 lg:w-fit" value="all">All Projects</option>
                            <option className="text-2xl max-w-40 lg:w-fit" value="active">Active Projects</option>
                            <option className="text-2xl max-w-40 lg:w-fit" value="completed">Completed Projects</option>
                        </select>
                    </div>
                </div>
